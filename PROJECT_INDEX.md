...
| `app/QuietNote/scripts/build-app.sh` | 2026-06-07 10:18 | 2026-06-11 00:34 | 构建脚本 | 编译、打包、ad-hoc 签名并生成 `build/LumaNote.app` | 不建议删除 | ad-hoc permission update test | 会复制 `AppIcon.icns` 到 app bundle，并执行 `codesign --force --deep --sign - --requirements '=designated => identifier "com.hututuo.lumanote"'` 与严格验证，用于测试更新后权限是否保留 |
