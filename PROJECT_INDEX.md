...
| `downloads/LumaNote-0.1.0-macos-arm64.zip` | 2026-06-10 23:59 | 2026-06-10 23:59 | GitHub 测试下载包 | 预构建 LumaNote 0.1.0 arm64 zip，用于测试从 GitHub 下载、解压、首次打开流程 | 可替换 | GitHub 下载流程测试 | 用户明确要求上传包；由 `build/LumaNote.app` 通过 `ditto --keepParent` 打包，app bundle 为 ad-hoc signed，SHA-256 见 `downloads/SHA256SUMS.txt` |
| `downloads/SHA256SUMS.txt` | 2026-06-10 23:59 | 2026-06-10 23:59 | 校验文件 | 记录测试下载包 SHA-256 | 不建议删除 | GitHub 下载流程测试 | `1dc9fa0d55e9e980839dc7d7088521d6ff0b3c4e5418d76b98b7ffcebd51247e` |
