...
| `app/QuietNote/scripts/build-dmg.sh` | 2026-06-11 00:02 | 2026-06-11 00:02 | DMG 构建脚本 | 将已签名 `LumaNote.app` 和 `/Applications` 快捷方式打包为拖拽安装 DMG | 不建议删除 | GitHub DMG 下载流程测试 | 输出 `build/LumaNote-<version>-macos-arm64.dmg`，并执行 `hdiutil verify` |
