...
| `appcast-test/appcast.xml` | 2026-06-11 00:42 | 2026-06-11 01:12 | Sparkle 测试 feed | `test/ad-hoc-permission-update` 分支的 Sparkle 更新源 | 可替换 | Sparkle 测试更新包 | `0.1.2` 临时测试更新包已回退；当前仅保留测试 feed 历史入口，后续正式发布需重新生成 appcast |
