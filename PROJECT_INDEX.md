...
| `app/QuietNote/scripts/generate-dmg-background.swift` | 2026-06-11 00:28 | 2026-06-11 00:28 | DMG 背景生成脚本 | 生成简约透明玻璃风格 DMG 背景图，含拖拽箭头和“未知开发者”打开步骤提示 | 不建议删除 | GitHub DMG 下载流程测试 | 生成 `support/dmg-background.png`；不绘制 app 名和 Applications 名，避免与 Finder 图标标签重复 |
| `app/QuietNote/support/dmg-background.png` | 2026-06-11 00:28 | 2026-06-11 00:28 | DMG 背景图 | DMG Finder 窗口使用的 retina PNG 背景 | 不建议删除 | GitHub DMG 下载流程测试 | 1440x920 PNG；由 `generate-dmg-background.swift` 可重建 |
