...
| `app/QuietNote/Sources/SettingsView.swift` | 2026-06-07 10:05 | 2026-06-08 22:35 | 设置窗口 | app 设置表单 | 不建议删除 | 开机自启设置 | 新增中文/English 分段选择；快捷键拆成快捷呼出、快捷关闭、打开剪切板库；透明度和磨砂强度下方有简短说明；完整设置页新增开机自启开关和失败提示 |
