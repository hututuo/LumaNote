...
struct MoreMenuView: View {
    ...
    var body: some View {
        ...
        ScrollView(.vertical) {
            VStack(alignment: .leading, spacing: 15) {
                ...
                UpdateCheckButtonView(settings: settings, updateActions: updateActions, compact: true)

                shortcutSettingsButton(copy: copy)
    ...
    private func shortcutSettingsButton(copy: AppText) -> some View {
        Button {
