...
- Sparkle permission-retention test update now uses `CFBundleShortVersionString=0.1.2` and `CFBundleVersion=3` so the locally installed `0.1.1` / build `2` baseline with the visible update button can pull a real update.
