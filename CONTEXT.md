...
- The island's title/detected value text and adjacent symbols should be stronger than the glass shell, not faded. Treat "20%/35% stronger" as increased visual weight from a full-strength baseline, not as 20%/35% opacity.
